 ...
 * @returns True if the word has any repeated consecutive letters
 */
 ...
 * @param word - Word to inspect
 * @returns True if the word has three or more repeated letters in a row
 */
 ...
 * @returns True if any three-letter sequence is alphabetical
 */
 ...
 * @returns Array of endings matched by the word
 */
